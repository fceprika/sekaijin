...
class StoreArticleRequest extends FormRequest
{
    ...
    {
        return [
            'title' => 'required|string|max:' . config('content.settings.title_max_length', 255),
            'slug' => 'nullable|string|max:255|unique:articles,slug',
            'excerpt' => 'required|string|max:' . config('content.settings.excerpt_max_length', 500),
            ...
            'reading_time' => 'nullable|integer|min:1|max:' . config('content.settings.max_reading_time', 60),
        ];
    }
