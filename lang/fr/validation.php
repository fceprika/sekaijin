...
return [
    ...
    */
    ...
    'custom' => [
        'youtube_username' => [
            'regex' => 'Le nom d\'utilisateur YouTube doit commencer par @ (ex: @monusername).',
        ],
        'instagram_username' => [
            'regex' => 'Le nom d\'utilisateur Instagram peut contenir seulement des lettres, chiffres, points et underscores.',
        ],
        'tiktok_username' => [
            'regex' => 'Le nom d\'utilisateur TikTok peut contenir seulement des lettres, chiffres, points et underscores (@ optionnel).',
        ],
        'linkedin_username' => [
            'regex' => 'Le nom d\'utilisateur LinkedIn peut contenir des lettres, chiffres, tirets, points et underscores.',
        ],
        'twitter_username' => [
            'regex' => 'Le nom d\'utilisateur Twitter peut contenir seulement des lettres, chiffres et underscores.',
        ],
        'facebook_username' => [
            'regex' => 'Le nom d\'utilisateur Facebook peut contenir des lettres, chiffres, points, underscores et tirets.',
        ],
        'telegram_username' => [
            'regex' => 'Le nom d\'utilisateur Telegram peut contenir seulement des lettres, chiffres et underscores.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'city_residence' => 'ville de résidence',
        'interest_country' => 'pays d\'intérêt',
        'bio' => 'biographie',
        'youtube_username' => 'nom d\'utilisateur YouTube',
        'instagram_username' => 'nom d\'utilisateur Instagram',
        'tiktok_username' => 'nom d\'utilisateur TikTok',
