                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden mt-8">
                        ...
                        <div class="bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-4 text-white">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <h2 class="text-xl font-bold">Événements organisés</h2>
                                        <p class="text-purple-100 text-sm">{{ $upcomingEvents->count() + $pastEvents->count() }} événements créés</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            ...
                            @if($upcomingEvents->count() > 0)
                                <div class="mb-6">
                                    <h3 class="text-lg font-semibold text-gray-800 mb-3 flex items-center">
                                        <span class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm mr-2">
                                            À venir
                                        </span>
                                    ...
                                    <div class="space-y-3">
                                                ...
                                                <div class="flex justify-between items-center">
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-gray-600">
                                                            ...
                                                            📍 {{ $event->is_online ? 'En ligne' : ($event->location ?: 'Lieu à confirmer') }}
                                                        </p>
                                                    </div>
                                        ...
                                        @if($upcomingEvents->count() > 3)
                                            <div class="text-center">
                                                <span class="text-gray-500 text-sm">... et {{ $upcomingEvents->count() - 3 }} autres</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                            ...
                            @if($pastEvents->count() > 0)
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-800 mb-3 flex items-center">
                                        <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm mr-2">
                                            Passés
                                        </span>
                                        {{ $pastEvents->count() }}
                                    </h3>
                                    <div class="space-y-2">
                                        @foreach($pastEvents->take(2) as $event)
                                        ...
                                        @if($pastEvents->count() > 2)
                                            <div class="text-center">
                                                <span class="text-gray-500 text-sm">... et {{ $pastEvents->count() - 2 }} autres</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
