                ...
                <div class="flex items-start justify-between mb-8">
                    <div class="flex-1 pr-4">
                        <div class="flex items-center mb-2 flex-wrap">
                            <span class="text-xl sm:text-2xl mr-2">{{ $countryModel->emoji }}</span>
                            <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Créer une annonce</h1>
                        </div>
                        <p class="text-sm sm:text-base text-gray-600">Publiez votre annonce pour la communauté française en {{ $countryModel->name_fr }}</p>
                    </div>
                    <a href="{{ route('country.annonces', $countryModel->slug) }}" class="text-gray-600 hover:text-gray-900 flex-shrink-0">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showStep(step) {
        ...
        // Mettre à jour les indicateurs desktop et mobile
