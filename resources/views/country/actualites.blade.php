                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <a href="{{ route('public.profile', strtolower($featuredNewsItem->author->name)) }}" class="text-sm text-gray-700 font-medium hover:text-blue-600">
                                ...
                                <article class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <a href="{{ route('public.profile', strtolower($newsItem->author->name)) }}" class="text-sm text-gray-700 font-medium hover:text-blue-600">
