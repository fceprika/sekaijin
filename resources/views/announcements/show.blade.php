    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="mb-6" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2 text-sm">
                ...
                <li>
                    <a href="{{ route('announcements.index') }}" class="text-gray-500 hover:text-gray-700">Annonces</a>
                </li>
                <li>
                    <span class="text-gray-400">/</span>
                </li>
                    ...
                    <div class="mt-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            @foreach($similarAnnouncements as $similar)
                                <a href="{{ route('announcements.show', $similar) }}" class="flex bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                    ...
                                    <div class="p-4 flex-1">
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">{{ $similar->city }}, {{ $similar->country }}</p>
